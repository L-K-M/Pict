...
/// Pict doesn't search: it ingests. The user finds the icon where searching is
/// still free, drags it over, and Pict does the validation, normalisation, storage
/// and attribution capture.
///
/// The honest cost of accepting a dragged URL is that Pict now fetches remote
