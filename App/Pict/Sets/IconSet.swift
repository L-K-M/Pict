...
/// One downloadable icon theme, and everything Pict needs to fetch and unpack it.
///
/// Linux desktops have large, coherent, freely licensed icon themes, and
/// `PLAN.md §2` settles what Pict does with them: fetch and update them
...
/// and Pict wants application icons at one size. Papirus is 31 MB compressed and
