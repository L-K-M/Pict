...
public enum IconSourceMode: String, CaseIterable, Identifiable {
    ...
    public var usesBundleArtwork: Bool { self != .system }

    /// Whether a user-chosen file overrides the app's own artwork.
    public var usesCustomIcons: Bool { self == .originalPlusCustom }
    ...
    public static var systemDefault: IconSourceMode {
    ...
    public static var isSquircleJailed: Bool {
