...
public enum BundleArtwork {
    ...
    public static func sources(forBundleAt bundleURL: URL,
    ...
    public static func infoDictionary(forBundleAt bundleURL: URL) -> [String: Any] {
    ...
    public static func candidateURLs(forResourceNamed name: String, in resources: URL,
    ...
    public static func image(forBundleAt bundleURL: URL) -> CGImage? {
    ...
    public static func image(forBundleID bundleID: String) -> CGImage? {
    ...
    public static func load(_ source: Source, bundleURL: URL) -> CGImage? {
        switch source {
        case .file(let url):
