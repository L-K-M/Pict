...
public enum IconImageValidator {
    ...
    public enum Limits {
        ...
        public static let masterLongestEdge = 1024
        /// A 10:1 banner destroys the icon row's rhythm; keep it near square.
        public static let minimumAspectRatio = 0.5
        public static let maximumAspectRatio = 2.0
    }
    ...
    public static func check(pixelWidth: Int, pixelHeight: Int,
    ...
    public static func decode(data: Data) -> Result<CGImage, Rejection> {
    ...
    public static func measure(contentsOf url: URL) -> Result<Measurements, Rejection> {
        let byteCount = (try? url.resourceValues(forKeys: [.fileSizeKey]))?.fileSize
    ...
    public static func writePNG(_ image: CGImage, to url: URL) -> Result<Void, Rejection> {
    ...
    public static func largestFrame(in source: CGImageSource) -> Frame? {
