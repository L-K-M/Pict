...
public enum IconShape: String, Equatable, CaseIterable {
    ...
    public var isWorthSubstituting: Bool { self != .empty }

    /// Whether the substituted artwork should get Zap's own corner rounding.
    public var needsCornerMask: Bool { self == .fullBleed }
...
public struct AlphaProfile: Equatable {
    ...
    /// circle.
    public var cornerReach: Double

    public init(hasInk: Bool, boundsWidth: Double, boundsHeight: Double,
                fillRatio: Double, cornerReach: Double) {
        self.hasInk = hasInk
    ...
    public static let empty = AlphaProfile(hasInk: false, boundsWidth: 0, boundsHeight: 0,
...
public enum IconShapeClassifier {
    ...
    public static func classify(_ profile: AlphaProfile) -> IconShape {
    ...
    public static func profile(of mask: AlphaMask) -> AlphaProfile {
